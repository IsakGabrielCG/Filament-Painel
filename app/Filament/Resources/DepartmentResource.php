...
class DepartmentResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Department'; // change the label in the sidebar

    protected static ?string $modelLabel = 'Department'; // change the label in the form

    protected static ?string $navigationGroup = 'System Management'; // create the group in the sidebar

    protected static ?int $navigationSort = 4; // change the order in the sidebar
